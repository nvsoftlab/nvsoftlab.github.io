...
const NAV_LINKS = [
  {
    ...
    label: "Party Room",
    Icon: Gamepad2,
    activeColor: "text-[#FF3D6E] bg-[#FF3D6E]/10",
  },
  {
    key: "OtherApps",
    label: "Other Apps",
...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] font-nunito">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            ...
            <Link
              ...
              className="flex items-center gap-2 sm:gap-3 group transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#FF3D6E] focus:ring-offset-2 focus:ring-offset-[#0a0a0a] rounded-lg"
            ...
            >
              ...
              <div className="flex flex-col justify-center">
                <h1 className="text-lg sm:text-xl font-black text-white leading-none">
                  NVSoftLab
                </h1>
                <p className="text-xs text-[#7a7a82] mt-0.5 hidden sm:block leading-none">Mobile App Studio</p>
              </div>
            </Link>
              ...
              {NAV_LINKS.map((link) => {
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-full transition-all duration-300 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-[#FF3D6E] focus:ring-offset-2 focus:ring-offset-[#0a0a0a] ${
            ...
            <button
              ...
              className="md:hidden flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 rounded-lg hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-[#FF3D6E] focus:ring-offset-2 focus:ring-offset-[#0a0a0a] transition-colors duration-200"
      ...
      {/* ── Footer ── */}
      <footer className="bg-[#0a0a0a] border-t border-white/10 mt-16 sm:mt-20">
