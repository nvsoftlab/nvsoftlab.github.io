  ...
  const features = [
    {
      ...
      description:
        "D4, D6, D8, D10, D12, D20 - every die for D&D, Pathfinder, and beyond.",
    },
    {
      icon: Layers,
    ...
    },
    {
      ...
      description:
        "Tap and get your number. Smooth haptic feedback on every roll.",
    },
    {
      icon: Repeat,
      title: "Quick Dice Switching",
      description:
        "Swap between dice types in a single tap. No menus, no friction.",
    },
    {
      icon: Feather,
    ...
    },
    {
      ...
      description:
        "Regular updates with new features driven by player feedback.",
    },
  ];
  ...
  const howItWorks = [
    {
      ...
      description:
        "Select from d4, d6, d8, d10, d12, or d20 - all the dice you need in one place.",
    },
    {
      step: "2",
      title: "Roll It",
      description:
        "Tap the die or shake your phone. Instant result with satisfying haptic feedback.",
    },
    {
      step: "3",
      title: "Keep Playing",
      description:
        "Switch dice in a tap, roll again, and keep your game moving without missing a beat.",
    },
  ];
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <div className="text-center mb-12 sm:mb-16">
        ...
        <p className="text-base sm:text-lg md:text-xl text-violet-100/80 mb-8 max-w-3xl mx-auto leading-relaxed px-2">
          D4 through D20, instant rolls, zero clutter. Built for tabletop gamers
          who left their dice at home - or just want something faster.
        </p>
          ...
          {howItWorks.map((item, index) => (
            ...
            >
              <CardContent className="p-6 sm:p-8">
                ...
                <h3 className="text-lg sm:text-xl font-black text-white mb-2 group-hover:text-violet-400 transition-colors duration-300">
                  {item.title}
                </h3>
                <p className="text-sm sm:text-base text-violet-100/70 leading-relaxed">
                  {item.description}
                </p>
              </CardContent>
            </Card>
      ...
      <div className="mb-16 sm:mb-20">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-violet-200/70">
            Whether you're rolling for initiative or just need a number
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {perfectFor.map((item, index) => (
            ...
            >
              ...
              <p className="text-violet-100/80 font-medium text-sm sm:text-base">
                {item.text}
              </p>
            </div>
          ))}
      ...
      {/* Download CTA */}
      <div
        className={`text-center bg-gradient-to-br from-violet-950/60 to-purple-950/40 border ${BORDER} rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12`}
      >
        <h2 className="text-2xl sm:text-3xl font-black text-white mb-3">
          Ready to Roll?
        </h2>
        <p className="text-violet-100/70 mb-8 max-w-2xl mx-auto">
          Download Dice Roll and never scramble for dice again.
        </p>
