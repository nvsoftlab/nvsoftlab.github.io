  ...
  const features = [
    {
      ...
      description:
        "1500+ questions across 30+ categories. You'll never repeat one.",
    },
    {
      icon: <Users className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
      title: "Questions for Friends",
      description:
        "The kind of questions that make you say 'wait, YOU did that?'",
    },
    {
      icon: <Heart className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
      title: "Questions for Couples",
      description:
        "Go beyond Netflix. Actually learn something about each other.",
    },
    {
  ...
  const howItWorks = [
    {
      ...
      description:
        "30+ themed decks - Friends, Couples, Spicy, Family, and way more.",
    },
    {
      step: "2",
      title: "Read the Question",
      description:
        "Someone reads a 'Have You Ever\u2026' question. The room goes quiet.",
    },
    {
      step: "3",
      title: "Answer & React",
      description:
        "Hands go up. Stories come out. Friendships are tested. Everyone laughs.",
    },
  ];

  const perfectFor = [
    {
      icon: <PartyPopper className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
      text: "Birthday parties that people actually remember",
    },
    {
      icon: <Coffee className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
      text: "Casual hangouts that turn into all-night sessions",
    },
    {
      icon: <Heart className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
      text: "Date nights that skip the awkward silence",
    },
    {
      icon: <Car className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
      text: "Road trips where nobody touches their phone",
    },
    {
      icon: <Home className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
      text: "Family nights that bring everyone closer",
    },
    {
      icon: <Users className="w-5 h-5 sm:w-6 sm:h-6 text-white" />,
      text: "Icebreakers that actually work",
    },
  ];
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <div className="text-center mb-16 sm:mb-20">
        ...
        <p className="text-base sm:text-lg md:text-xl text-pink-100/80 mb-8 max-w-3xl mx-auto leading-relaxed px-2">
          1500+ questions across 30+ categories that turn any hangout into a
          night to remember. From hilarious confessions to jaw-dropping reveals
          - this is the game everyone talks about the next day.
        </p>
          ...
          {howItWorks.map((item, index) => (
            ...
            >
              <CardContent className="p-6 sm:p-8">
                ...
                <h3 className="text-lg sm:text-xl font-black text-white mb-2 group-hover:text-pink-400 transition-colors duration-300">
                  {item.title}
                </h3>
                <p className="text-sm sm:text-base text-pink-100/70 leading-relaxed">
                  {item.description}
                </p>
              </CardContent>
            </Card>
      ...
      <div className="mb-16 sm:mb-20">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-pink-200/70">
            Built for real moments, not small talk
          </p>
        </div>
      ...
      <div className="mb-16 sm:mb-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {perfectFor.map((item, index) => (
            <div
              key={index}
              className={`flex items-center gap-3 sm:gap-4 ${CARD_BG} border ${BORDER} p-4 sm:p-5 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 group`}
            >
              <div
                className={`w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r ${ACCENT} rounded-lg flex-shrink-0 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
              >
                {item.icon}
              </div>
              <p className="text-pink-100/80 font-medium text-sm sm:text-base">
                {item.text}
              </p>
            </div>
          ))}
      ...
      {/* Download CTA */}
      <div
        className={`text-center bg-gradient-to-br from-pink-950/60 to-purple-950/40 border ${BORDER} rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12`}
      >
        <h2 className="text-2xl sm:text-3xl font-black text-white mb-3">
          The Best Nights Start with One Question
        </h2>
        <p className="text-pink-100/70 mb-8 max-w-2xl mx-auto">
          Download Have You Ever and find out what your friends have really been
          up to.
        </p>
